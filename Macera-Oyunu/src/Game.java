...
public class Game {
    ...
    public void start() {
        ...
        System.out.print("Please select a name : ");
        ...
        while (true) {
            ...
            System.out.println("3 - Cave --> Award <Food>. Prepare the zombies!!!");
            System.out.println("4 - Forest --> Award <Wood>. Take care the Vampires!!!");
            System.out.println("5 - River --> Award <Water>. Silence!. Don't wake up the Bear!!!");
            ...
            if (location == null){
                System.out.println("YOU'VE GIVE UP!");
                break;
            }
